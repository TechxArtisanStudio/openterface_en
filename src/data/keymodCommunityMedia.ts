...
export const keymodCommunityFeed: KeymodCommunityItemDef[] = [
  ...
  },
  {
    ...
    author: '@_m0usem0use_',
    excerpt: 'KeyMod is 100% always in my bag — a full functioning keyboard and mouse trackpad.',
    scenarioTag: 'EDC',
    featured: true,
    sort: 30,
  },
  {
    ...
    platform: 'instagram',
    format: 'post',
    externalUrl: 'https://www.instagram.com/p/DZRsM93P-mU/',
  ...
  // Official demos — not on landing strip; available for /media/ sync later
  {
    ...
    thumbnail: '/keymod/rebirth/modes/km-compose-send.webp',
    author: '@techxartisan',
    excerpt: 'Paste on phone, tap Send — the laptop types it in automatically.',
